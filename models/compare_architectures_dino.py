...
DEFAULT_K_FOLDS = int(os.getenv("K_FOLDS", 1))
...
DEFAULT_PRETRAIN_EPOCHS = int(os.getenv("DINO_PRETRAIN_EPOCHS", 3))
DEFAULT_FINETUNE_EPOCHS = int(os.getenv("DINO_FINETUNE_EPOCHS", 3))
